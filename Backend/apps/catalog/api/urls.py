...
urlpatterns = [
    ...
    path("catalog/collections/",                                         views.CollectionListView.as_view(),        name="collection-list"),
    path("catalog/collections/<slug:slug>/",                             views.CollectionDetailView.as_view(),      name="collection-detail"),
    path("catalog/collections/<slug:slug>/products/",                    views.CollectionProductListView.as_view(), name="collection-product-list"),
    ...
    path("catalog/listings/",                                            views.ListingListView.as_view(),           name="listing-list"),
    path("catalog/listings/<slug:slug>/",                                views.ListingDetailView.as_view(),         name="listing-detail"),

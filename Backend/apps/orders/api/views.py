...
def _get_full_cart(request):
    cart, _ = Cart.objects.prefetch_related(_cart_items_prefetch()).get_or_create(
...
class CartItemAddView(APIView):
    def post(self, request):
        ...
        s = CartItemWriteSerializer(data=request.data, context={"request": request})
...
class OrderStatusUpdateView(generics.UpdateAPIView):
    ...
    def get_queryset(self):
        return for_request(Order.objects.all(), self.request)

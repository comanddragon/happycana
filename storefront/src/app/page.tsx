...
export const metadata: Metadata = {
    ...
    description: `Shop lab-tested cannabis flower, edibles, pre-rolls, vapes, concentrates, CBD products, and more from ${DEFAULT_STOREFRONT_NAME}.`,
    alternates: { canonical: '/' },
    openGraph: {
        title: `${DEFAULT_STOREFRONT_NAME} | Lab-Tested Cannabis for Pickup & Delivery`,

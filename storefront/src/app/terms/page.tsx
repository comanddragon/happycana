...
export const metadata: Metadata = {
    title: `Terms of Service | ${DEFAULT_STOREFRONT_NAME}`,
    description: `The terms governing your use of ${DEFAULT_STOREFRONT_NAME}.`,
}
        ...
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
            ...
            <div className="mt-10 space-y-8 text-hc-ink-soft [&_h2]:font-hc-display [&_h2]:text-xl [&_h2]:font-medium [&_h2]:text-hc-ink [&_h2]:mb-2 [&_p]:leading-relaxed">
                <section>
                    ...
                    <p>
                        You must meet the applicable minimum age to purchase from {DEFAULT_STOREFRONT_NAME}, and regulated products may

...
import { DEFAULT_STOREFRONT_NAME, safeJsonLd } from '@/lib/storefront'

export const metadata: Metadata = {
    title: `Contact & Help | ${DEFAULT_STOREFRONT_NAME}`,
    description: `Get in touch with ${DEFAULT_STOREFRONT_NAME}, or find answers to common questions about ordering and shipping.`,
}

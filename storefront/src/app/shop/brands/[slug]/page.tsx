...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    if (!brand) return {}
    const description = brand.meta_description || brand.description || `Shop ${brand.name} products at ${DEFAULT_STOREFRONT_NAME}.`
    return {
...
export default async function BrandPage({ params, searchParams }: Props) {
    ...
    const schema = {
        ...
        url: `${canonicalOrigin}/shop/brands/${brand.slug}`, ...(brand.logo_url && { logo: brand.logo_url }),

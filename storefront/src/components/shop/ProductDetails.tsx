...
import { cn, formatPrice, mediaUrl, getVariantLabel, formatWeight, stripHtml, titleCase, COMPLIANCE_CATEGORY_LABEL } from '@/lib/utils'
import {
    Product,
    ProductVariant,
    ProductImage,
            ...
            <div className="grid lg:grid-cols-2 gap-12">
                ...
                <div className="flex flex-col gap-5">
                    ...
                    {variant && variant.attributes.length > 0 ? (
                        ...
                        features.cannabisCatalog ? <CannabisProductSpecs product={product} variant={variant} /> : null
                    )}
...
function _ProductSpecs({ product, variant }: { product: Product; variant: ProductVariant | null }) {

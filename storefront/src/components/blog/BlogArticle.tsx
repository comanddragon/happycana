...
export function BlogArticle({ post }: Props) {
    ...
    const jsonLd = {
        ...
        publisher: {
            ...
            logo: { '@type': 'ImageObject', url: `${canonicalOrigin}/favicon.ico` },
        },
        ...(post.author ? { author: { '@type': 'Person', name: post.author } } : {}),
        mainEntityOfPage: `${canonicalOrigin}/blog/${post.slug}`,
    }
    const breadcrumbLd = {
        '@context': 'https://schema.org',
        '@type': 'BreadcrumbList',
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: post.title, item: `${canonicalOrigin}/blog/${post.slug}` },
        ],
    }

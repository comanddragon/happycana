// app/learn/lab-results/page.tsx
...
export const metadata: Metadata = {
    ...
    alternates: { canonical: '/learn/lab-results' },
}
    ...
    return (
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
            ...
            <p className="mt-3 max-w-2xl text-hc-ink-soft leading-relaxed">
                ...
                page lists them all in one place — click through to a product to see its full COA. See{' '}
            ...
            {(hasPrev || hasNext) && (
                <div className="mt-6 flex items-center justify-between">
                    {hasPrev ? (
                        <Link href={`/learn/lab-results?page=${pageNum - 1}`} className="flex items-center gap-1 text-sm font-medium text-hc-amber-dim hover:underline">
